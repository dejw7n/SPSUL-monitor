...
?>
        <?php
            ...
            function akce($str){
                ...
                else if(strpos($str, "kulturní akce")){
                    array_push($tmp, 'kult');
                }
                else if(strpos($str, "přednáška")){
                    array_push($tmp, 'před');
                }
                else if(strpos($str, "exkurze")){
                    array_push($tmp, 'exku');
                }
                else{
                    array_push($tmp, 'akce');
            ...
            <div class="row" style="min-height: 527px;">
                ...
                <div class="col-xs-6">
                    ...
                    <div style="height: 35px;">
                        <p class="rozvrhName" style="width: 87%; float: left;">Dnes:<p style="font-size: 10px;width: 100%; height: 35px; line-height: 48px; text-align: right;">(středisko Resslova)</p></p>
                    </div>
                ...
                <div class="col-xs-6">
                    ...
                    <?php else : ?>
                        ...
                        <div style="height: 35px;">
                            <p class="rozvrhName" style="width: 27%; float: left;">Příští školní den:<p style="font-size: 10px;width: 100%; height: 35px; line-height: 48px; text-align: right;">(středisko Resslova)</p></p>
                        </div>  
                            <div id="schedule" style="min-width: auto; visibility: visible; float: left;">
