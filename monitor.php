...
if (isset($_GET['stredisko']) && $_GET['stredisko'] == 'stribrniky') {
    $center = 'stribrniky';
    $centerId = 2;
} else {
    $center = 'resslova';
...
<body>
    ...
    <div class="w-screen h-screen flex flex-col gap-8">
        ...
        <div class="grid gap-4">
            ...
            $sis = new sis();
            $posts = json_decode($sis->getPosts($centerId));
                        ...
                        <div class="w-full h-fit grid gap-4">
                            <div class="flex">
                                ...
                                <div class="ml-4">
                                    ...
                                    ?>
                                        <span *ngIf="post.center_id == 1 || post.center_id == 3" class="px-3 py-1 rounded-full isolate bg-orange-600">RESSLOVA</span>
                                        <?php
                                    }
                                    if ($post->center_id == 2 || $post->center_id == 3) {
                                    ?>
                                        <span *ngIf="post.center_id == 2 || post.center_id == 3" class="px-3 py-1 rounded-full isolate bg-blue-600">STŘÍBRNÍKY</span>
                                        <?php
                                    }
                                    ?>
